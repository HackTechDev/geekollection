...
final class Version20231027191202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE library_movie (library_id INT NOT NULL, movie_id INT NOT NULL, INDEX IDX_B9D4EF73FE2541D7 (library_id), INDEX IDX_B9D4EF73126F525E (movie_id), PRIMARY KEY(library_id, movie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE library_movie ADD CONSTRAINT FK_B9D4EF73FE2541D7 FOREIGN KEY (library_id) REFERENCES library (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE library_movie ADD CONSTRAINT FK_B9D4EF73126F525E FOREIGN KEY (movie_id) REFERENCES movie (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE library_movie DROP FOREIGN KEY FK_B9D4EF73FE2541D7');
        $this->addSql('ALTER TABLE library_movie DROP FOREIGN KEY FK_B9D4EF73126F525E');
        $this->addSql('DROP TABLE box');
        $this->addSql('DROP TABLE edition');
        $this->addSql('DROP TABLE movie');
        $this->addSql('DROP TABLE library');
        $this->addSql('DROP TABLE library_user');
        $this->addSql('DROP TABLE library_movie');
